...
def call_algo(params):
    if params["algo"]==1:
        ...
        #rewards_array_list = reinforce_baseline(params,1,0.001,0.001)
        ...
        for i in alpha_theta_values:
            rewards_array, cumulative_rewards, average_reward, no_steps, cumulative_steps = reinforce_baseline(params,0.9,i,0.001)
        ...
        for i in alpha_w_values:
            rewards_array, cumulative_rewards, average_reward, no_steps, cumulative_steps = reinforce_baseline(params,0.9,0.001,i)
            rewards_array_list.append(rewards_array)
            cumulative_rewards_list.append(cumulative_rewards)
            average_reward_list.append(average_reward)
            no_steps_list.append(no_steps)
